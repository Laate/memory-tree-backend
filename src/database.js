...
// We always send back status 500 when getting an error, even if the client sends an invalid request.
// We should check for client error and send back status 400.
